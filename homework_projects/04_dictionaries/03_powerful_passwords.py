...
def login(email, stored_logins, password_to_check):
    ...
    password_to_check: the password to verify against the stored hash
    """
    return stored_logins.get(email) == hash_password(password_to_check)

def hash_password(password):
    """
    Returns the SHA256 hashed value of the input password.
    """
...
def main():
    ...
    print(login("example@gmail.com", stored_logins, "word"))   # True
    print(login("example@gmail.com", stored_logins, "password"))  # False
